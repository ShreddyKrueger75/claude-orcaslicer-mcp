...
- v0.4.0: watch_print monitoring, multi-material/plate/skip slicing, end-to-end fixture tests (real socket: digest auth, Duet sessions), GitHub Actions CI + CONTRIBUTING. 42 self-tests green.
